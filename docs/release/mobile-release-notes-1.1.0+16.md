...
이후 기존 앱 구조에 새 스타일을 입힌 별도 B안도 만들었다. A안은 `d3625ef`로 보존했으며, B안의 124개 테스트·빌드 결과와 비교 기준은 [모바일 디자인 A/B안 기록](mobile-design-variants-2026-09-05.md)을 따른다. 두 안 모두 스토어에 제출하지 않은 디자인 후보이다.
