...
**후속 상태 2026-09-05 15:18 KST:** 워커 v10에서 3절의 스크롤 종료·완전성 검사를 수정하고 NAS에 배포했다. 기존 v9 후보는 다시 수집하지 않아 내용이 바뀌지 않았다. 1·2절의 팀 별칭·규정 IN/OUT 비교 키는 v25에서도 미수정이다. 419건을 실제 선수 삭제로 확정하거나 일괄 승인하지 않는다. 최신 검수·배포 결과는 [v25/v10 기록](uniqueplay-record-quality-v25-v10-2026-09-05.md)을 참조한다. 아래 내용은 수정 전 재현 이력이다.
