...
- 릴리즈명 템플릿: `1.0.6 (15)`
- 릴리즈 노트 템플릿:
  - 웹 등록 경기 시간과 앱 표시 시간의 시간대 오차 수정
  - 일정 날짜 분류(오늘/내일/날짜 그룹핑) 로컬 기준 통일
...
- 테스트 계정:
  - 이메일: `[입력 필요]`
  - 비밀번호: `[입력 필요]`
- 심사 정보 메모: `docs/release/mobile-release-notes-1.0.6+15.md` 사용
- 재심사 답변 문안: 필요 시 별도 작성
- 검증 경로:
