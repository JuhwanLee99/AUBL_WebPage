    ...
    items: [
      _ManualItem(
        ...
        bullets: [
          ...
          '공지 상세 우측 메뉴에서 게시글 신고/작성자 차단',
          '댓글 우측 메뉴에서 신고/차단/삭제(권한 보유 시)',
          '차단 시 해당 사용자 게시글/댓글이 즉시 숨김 처리',
          '갤러리 배너로 외부 커뮤니티 이동',
        ],
      ),
      _ManualItem(
        ...
        bullets: [
          ...
          '게시글/댓글 우측 메뉴에서 신고/차단 가능',
          '차단 시 차단 대상 사용자의 콘텐츠가 즉시 숨김 처리',
        ],
      ),
      _ManualItem(
        heading: '선수 등록 게시판',
        bullets: [
          ...
          '게시글 우측 메뉴에서 신고/작성자 차단 가능',
          '로그인 상태 변경 시 열람 권한이 즉시 재평가됩니다.',
    ...
    items: [
      ...
      _ManualItem(
        ...
        bullets: [
          ...
          '댓글 우측 메뉴에서 신고/작성자 차단 가능',
          '차단 시 차단 대상 사용자의 댓글/답글이 즉시 숨김 처리',
        ],
      ),
    ],
  ),
  ...
  _ManualSection(
    ...
    items: [
      _ManualItem(
        heading: '더보기 > 관리자 섹션',
        bullets: [
          '관리자/기록원 권한 계정에 운영 메뉴가 노출됩니다.',
          '기록원 계정은 기록원/경기 기록 수정 메뉴만 표시됩니다.',
        ],
      ),
    ],
  ),
...
final _troubleshooting = <({String title, List<String> steps})>[
  ...
  (
    ...
    steps: [
      '계정 역할 재확인',
      '관리자/기록원 권한 반영 후 재로그인',
      '여전히 미노출 시 권한 매핑(admin claim, roles) 점검',
    ],
  ),
  (
    title: '선수 등록 권한이 반영되지 않을 때',
    steps: [
      '로그인/로그아웃 직후에는 권한이 자동 재평가됩니다. 잠시 후 다시 진입',
      '커뮤니티 화면을 당겨 새로고침하거나 앱을 재포그라운드로 전환',
      '여전히 접근 불가 시 roles/team 멤버십 매핑 상태 점검',
    ],
  ),
  (
    title: '종료 경기 기록을 수정해야 할 때',
    steps: [
      '더보기 > 경기 기록 수정(/admin/games)으로 진입합니다.',
