...
enum _InquiryModerationAction { report, block, delete }
...
class _InquiryDetailScreenState extends State<InquiryDetailScreen> {
  ...
  Color _platformColor(String p) =>
      p == 'app' ? context.aublColors.cobalt : context.aublColors.navy;
                      ...
                      children: [
                        if (isPostBlocked)
                          ...
                          Wrap(
                            ...
                            children: [
                              _badge(
                                _post.platform == 'app' ? '앱' : '웹',
                                _platformColor(_post.platform),
                              ),
                              _badge(
                                _post.category,
                                _categoryColor(_post.category),
                              ),
                              if (_isAdmin)
