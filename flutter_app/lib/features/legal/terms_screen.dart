...
const _kSections = [
  ...
  _Section('제2조 (정의)', [
    ...
    '"회원"이란 본 약관에 동의하고 이메일·비밀번호 또는 Google/Apple(iOS 앱) 계정을 통해 가입한 이용자를 말합니다.',
  ...
  _Section('제4조 (회원 가입 및 탈퇴)', [
    '회원 가입은 이메일·비밀번호 등록 또는 Google/Apple(iOS 앱) 계정을 통한 소셜 로그인으로 이루어지며, 가입 시 본 약관 및 개인정보 처리방침에 동의한 것으로 간주합니다.',
