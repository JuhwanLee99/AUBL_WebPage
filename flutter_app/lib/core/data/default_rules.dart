class RuleArticle {
  const RuleArticle({required this.title, required this.body});
  final String title;
...
const defaultRuleChapters = [
  RuleChapter(
    title: '제1장 총회',
    accent: 0xFF60a5fa,
    articles: [
      RuleArticle(title: '제1조 (명칭)', body: [
        '본 회는 "전국 대학 아마추어 야구 연합회"라 한다.',
      ]),
      RuleArticle(title: '제2조 (목적)', body: [
        '본 회는 회원 상호 친목과 상부상조를 도모하고, 학교체육 발전에 기여함을 목적으로 한다.',
      ]),
      RuleArticle(title: '제3조 (사업)', body: [
      ...
      RuleArticle(title: '제4조 (소재지)', body: [
        '본 회의 사무소는 회장교에 설치하며, 필요에 따라 지부를 운영할 수 있다.',
      ]),
    ],
  ),
  RuleChapter(
    ...
    accent: 0xFFa855f7,
    articles: [
      RuleArticle(title: '제5조 (회원자격)', body: [
      ...
      RuleArticle(title: '제6조 (권리 및 의무)', body: [
        '회원은 의결권과 선거권을 갖는다.',
  ...
  RuleChapter(
    ...
    accent: 0xFF34d399,
    articles: [
      RuleArticle(title: '제7조 (기관)', body: [
        '본 회의 최고 의결 기관은 운영위원회로 하며, 각 학교 대표자 1명으로 구성한다.',
      ]),
      RuleArticle(title: '제8조 (회의소집)', body: [
        '매년 3월 및 9월에 정기회의를 소집하며, 필요 시 임시회의를 소집할 수 있다.',
      ]),
      RuleArticle(title: '제9조 (정족수)', body: [
        '회의 정족수는 전년도 리그 참가 팀수를 기준으로 한다.',
      ]),
    ],
  ),
  RuleChapter(
    ...
    accent: 0xFFf97316,
    articles: [
      RuleArticle(title: '제10조 (집행부서)', body: [
        '본 회의 집행 부서는 다음과 같다.',
        '1. 운영부',
        '2. 심판부',
        '3. 기록부',
  ...
  RuleChapter(
    ...
    accent: 0xFF38bdf8,
    articles: [
      RuleArticle(title: '제11조 (재정)', body: [
        '본 회의 재정은 회비, 입회비, 사업수입, 찬조금 등으로 충당한다.',
      ]),
      RuleArticle(title: '제12조 (회계연도)', body: [
        '회계연도는 회장교 인수인계 시부터 차년도 인수인계까지로 한다.',
      ]),
      RuleArticle(title: '제13조 (감사)', body: [
  ...
  RuleChapter(
    ...
    accent: 0xFFef4444,
    articles: [
      RuleArticle(title: '제15조 (상벌)', body: [
        '▸ 출전불가 사유별 규정',
  ...
  RuleChapter(
    ...
    accent: 0xFFfacc15,
    articles: [
      RuleArticle(title: '제17조 (경기규칙)', body: [
        '본 회의 공식 경기는 다음 규칙에 따라 운영한다.',
      ]),
      RuleArticle(title: '경기시간', body: [
        '• 3경기 시: 09시, 12시, 15시',
        '• 2경기 시: 10시 30분, 13시 30분',
        '• 한 경기의 시간 제한은 2시간 30분을 기준으로 한다.',
        '• 경기 종료 10분 전 새 이닝 불가',
      ]),
      RuleArticle(title: '게임 진행', body: [
        '• 조별 예선: 시간제한, 콜드게임 있는 7이닝',
        '• 예선 콜드: 4회 15점, 5회 10점, 6회 7점',
        '• 토너먼트 8강/4강: 예선 동일 규정 적용',
        '• 4강 이후: 시간제한 없음',
      ]),
      RuleArticle(title: '경기 불참 · 몰수', body: [
        '• 개시 20분 미참: 몰수게임',
      ...
      RuleArticle(title: '시합구', body: [
        '• 골드볼파크의 공을 사용한다.',
        '• GBPCL 등급 이상',
        '• 경기 전 양팀 3개씩 제출',
      ]),
      RuleArticle(title: '고등학교선수 출신 (선출) 규정', body: [
        '• 한 경기 후보를 포함하여 라인업지에 최대 2명',
        '• 투수 및 포수 불가',
        '• 여자선수: 선출 여부와 무관하게 일반선수 자격 부여',
        '• 조별 예선 1/3 이상 참여 시 본선 출전 자격',
      ]),
      RuleArticle(title: '배트 규정', body: [
        '▸ 일반선수',
        '• 나무 및 알로이 배트만 사용 가능',
  ...
  RuleChapter(
    ...
    accent: 0xFF94a3b8,
    articles: [
      RuleArticle(title: '제18조 (사안가결)', body: [
        '징계 대상 학교 및 기권표는 투표에 포함하지 않는다.',
      ]),
    ],
  ),
];

const defaultRuleHostOrder = [
  '서강대',
  '홍익대',
  '고려대',
  '연세대',
