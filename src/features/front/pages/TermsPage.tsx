...
const SECTIONS = [
  ...
  },
  {
    ...
    items: [
      ...
      '회원은 언제든지 앱 내 "더보기 → 계정 → 회원 탈퇴"에서 탈퇴를 요청할 수 있으며, 웹 계정 삭제 안내 페이지(https://aubl.club/account-deletion)에서도 삭제 절차를 확인할 수 있습니다. 탈퇴 시 회원 정보는 지체 없이 파기하되, 투표 이의 처리 및 법령상 보존이 필요한 기록은 개인정보 처리방침의 기간을 따릅니다.',
  ...
  },
  {
    ...
    items: [
      'AUBL은 다음 서비스를 제공합니다: 경기 일정·결과 조회, 실시간 문자중계, 선수 기록 열람, 커뮤니티(공지·갤러리), 팀 관리, 푸시 알림, 올스타·루키 후보 공개 및 투표.',
      '올스타·루키 투표는 이벤트별로 공지된 참여 주기(예: 계정당 1회 또는 계정당 1일 1회), 후보와 포지션별 선택 수, 투표 기간에 따라 운영됩니다.',
  ...
  },
  {
    ...
    items: [
      ...
      '여러 계정, 자동화 도구 또는 인증 우회 수단을 이용해 투표 참여 제한을 회피하거나 결과를 인위적으로 조작해서는 안 됩니다.',
