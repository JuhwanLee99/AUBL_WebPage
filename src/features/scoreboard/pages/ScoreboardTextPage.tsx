...
import {
  ...
  type OfficialGameDetailTeam,
  type OfficialGameDetailsResponse,
  type OfficialPitcherGameRow,
...
function OfficialGameDetailLoading() {
  return (
...
function OfficialGameDetailMessage({
  title,
  description,
  onRetry,
}: {
...
function OfficialGameDetailView({
  payload,
  onRetry,
}: {
  ...
  return (
    <main className="official-game-detail">
      <header className="official-game-detail__hero">
