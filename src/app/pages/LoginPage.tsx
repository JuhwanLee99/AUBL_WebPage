                  ...
                  {googleConsentTab === 'terms' ? (
                    <>
                      {[
                        ...
                        { title: '제2조 (정의)', items: ['"서비스"란 경기 일정·결과 조회, 실시간 문자중계, 기록 열람, 커뮤니티, 푸시 알림 등 일체의 서비스를 말합니다.', '"회원"이란 본 약관에 동의하고 이메일·비밀번호 또는 Google 계정을 통해 가입한 이용자를 말합니다.'] },
                        { title: '제3조 (약관의 효력 및 변경)', items: ['변경된 약관에 동의하지 않는 경우 회원 탈퇴를 할 수 있으며, 고지 후 7일 이내 탈퇴하지 않은 경우 동의한 것으로 간주합니다.'] },
                        { title: '제4조 (회원 가입 및 탈퇴)', items: ['회원 가입은 이메일·비밀번호 등록 또는 Google 계정을 통한 소셜 로그인으로 이루어지며, 가입 시 본 약관 및 개인정보 처리방침에 동의한 것으로 간주합니다.', '회원은 언제든지 앱 내 "더보기 → 계정 관리"에서 탈퇴를 요청할 수 있으며, 탈퇴 시 개인정보는 즉시 파기됩니다.'] },
                        { title: '제5조 (서비스의 제공 및 변경)', items: ['AUBL은 경기 일정·결과 조회, 실시간 문자중계, 선수 기록 열람, 커뮤니티, 팀 관리, 푸시 알림 서비스를 제공합니다.', '서비스는 무료로 제공되며, 향후 유료 서비스 도입 시 별도 고지 후 동의를 받습니다.'] },
                        ...
                        { title: '제9조 (책임의 제한)', items: ['AUBL은 비영리 대학생 단체로서 서비스를 "있는 그대로(AS-IS)" 제공하며, 서비스의 완전성·정확성·신뢰성을 보증하지 않습니다.'] },
                    ...
                    <>
                      {[
                        { title: '1. 개인정보의 수집 항목 및 수집 방법', items: ['수집 항목: 이메일 주소, 이름(Google 로그인 시), 계정 고유 식별자(UID)', '자동 수집: 기기 식별 정보, 앱 버전, OS 종류 및 버전, FCM 푸시 토큰', '수집 방법: 이메일·비밀번호 회원가입 또는 Google 로그인(OAuth 2.0)'] },
                        { title: '2. 개인정보의 수집 및 이용 목적', items: ['회원 식별 및 가입 의사 확인', '리그 경기 일정·결과·기록 조회 서비스 제공', '커뮤니티 게시글 작성·관리', '팀 공지사항 및 경기 알림(푸시 알림) 발송'] },
                        ...
                        { title: '5. 개인정보의 처리 위탁', items: ['Firebase (Google LLC): 인증, 데이터 저장, 푸시 알림 서비스 운영', 'Google Cloud Platform: 클라우드 함수 실행 및 데이터 처리'] },
                        { title: '6. 이용자의 권리와 행사 방법', items: ['이용자는 언제든지 자신의 개인정보를 조회·수정·삭제할 수 있습니다.', '앱 내 "더보기 → 계정 관리"에서 직접 처리하거나, aublcau@gmail.com으로 요청할 수 있습니다.'] },
